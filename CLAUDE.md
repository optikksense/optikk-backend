...
- When you are working on optikk, refining a feature or implementing new one, it should be like, feature is simpler on top but it unfolds if someone tries to dig deeper

- No legacy support is needed unless mentioned
...
Database Schemas got clickhouse are 
