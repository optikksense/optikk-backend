-- Raw OTLP logs (explorer schema; single table — shaped like logs_v2).
CREATE TABLE IF NOT EXISTS observability.logs_v2 (
    ...
    INDEX idx_resource_fp  resource_fingerprint TYPE bloom_filter(0.01)  GRANULARITY 1,
...
ORDER BY (team_id, ts_bucket_start, resource_fingerprint, severity_bucket, timestamp, trace_id, span_id)
