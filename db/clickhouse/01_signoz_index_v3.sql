-- Raw OTLP spans (single schema; shaped like signoz_index_v3).
CREATE TABLE IF NOT EXISTS observability.signoz_index_v3 (
    ...
    resource_fingerprint                  String
                                    MATERIALIZED attributes.`resource_fingerprint`::String CODEC(ZSTD(1)),
    ...
    INDEX idx_resource_fingerprint  resource_fingerprint    TYPE bloom_filter(0.01)      GRANULARITY 4,
...
ORDER BY (team_id, ts_bucket_start, resource_fingerprint, service_name, name, timestamp, trace_id, span_id)
