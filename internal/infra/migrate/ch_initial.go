...
// chUp001 applies the initial ClickHouse schema.
// When production=true it uses ReplicatedMergeTree with tiered GCS storage.
// When production=false it uses plain MergeTree with simple TTL.
func chUp001(production bool) func(ctx context.Context, db *sql.DB) error {
...
// chDown001 drops all tables created by the initial migration.
func chDown001(ctx context.Context, db *sql.DB) error {
...
// ---------------------------------------------------------------------------
// Local (development) DDL — MergeTree, simple TTL, no storage policy
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Production DDL — ReplicatedMergeTree, tiered GCS storage, multi-stage TTL
// ---------------------------------------------------------------------------
