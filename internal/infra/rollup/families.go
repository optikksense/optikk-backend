...
// to For / TierTableFor; the package appends the tier suffix ("_1m" /
...
var AllFamilies = []string{
	FamilySpansRED, FamilySpansKind, FamilySpansHost, FamilySpansTopology,
	FamilySpansPeer, FamilySpansVersion, FamilySpansErrors,
