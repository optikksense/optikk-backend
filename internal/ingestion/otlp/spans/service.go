...
func NewService(authenticator platformingestion.TeamResolver, d platformingestion.Dispatcher[*SpanRow], tracker platformingestion.SizeTracker, limiter platformingestion.Limiter) *Service {
	return &Service{
		auth:       authenticator,
		dispatcher: d,
		tracker:    tracker,
