...
func NewModule(authenticator platformingestion.TeamResolver, tracker platformingestion.SizeTracker, d platformingestion.Dispatcher[*LogRow]) registry.Module {
