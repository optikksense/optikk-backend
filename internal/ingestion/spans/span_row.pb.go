...
// 	protoc        v6.31.1
// source: internal/ingestion/spans/span_row.proto
...
func (x *Row) Reset() {
	*x = Row{}
	mi := &file_internal_ingestion_spans_span_row_proto_msgTypes[0]
...
func (*Row) Descriptor() ([]byte, []int) {
	return file_internal_ingestion_spans_span_row_proto_rawDescGZIP(), []int{0}
}
...
var File_internal_ingestion_spans_span_row_proto protoreflect.FileDescriptor

const file_internal_ingestion_spans_span_row_proto_rawDesc = "" +
	"\n" +
	"'internal/ingestion/spans/span_row.proto\x12\x16optikk.ingest.spans.v1\"\xef\b\n" +
	"\x03Row\x12&\n" +
...
var (
	file_internal_ingestion_spans_span_row_proto_rawDescOnce sync.Once
	file_internal_ingestion_spans_span_row_proto_rawDescData []byte
)

func file_internal_ingestion_spans_span_row_proto_rawDescGZIP() []byte {
	file_internal_ingestion_spans_span_row_proto_rawDescOnce.Do(func() {
		file_internal_ingestion_spans_span_row_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_internal_ingestion_spans_span_row_proto_rawDesc), len(file_internal_ingestion_spans_span_row_proto_rawDesc)))
	})
	return file_internal_ingestion_spans_span_row_proto_rawDescData
}

var file_internal_ingestion_spans_span_row_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_internal_ingestion_spans_span_row_proto_goTypes = []any{
	(*Row)(nil), // 0: optikk.ingest.spans.v1.Row
	nil,         // 1: optikk.ingest.spans.v1.Row.AttributesEntry
}
var file_internal_ingestion_spans_span_row_proto_depIdxs = []int32{
...
func init() { file_internal_ingestion_spans_span_row_proto_init() }
func file_internal_ingestion_spans_span_row_proto_init() {
	if File_internal_ingestion_spans_span_row_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_internal_ingestion_spans_span_row_proto_rawDesc), len(file_internal_ingestion_spans_span_row_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_internal_ingestion_spans_span_row_proto_goTypes,
		DependencyIndexes: file_internal_ingestion_spans_span_row_proto_depIdxs,
		MessageInfos:      file_internal_ingestion_spans_span_row_proto_msgTypes,
	}.Build()
	File_internal_ingestion_spans_span_row_proto = out.File
	file_internal_ingestion_spans_span_row_proto_goTypes = nil
	file_internal_ingestion_spans_span_row_proto_depIdxs = nil
}
