...
const file_log_row_proto_rawDesc = "" +
	"\n" +
	"\rlog_row.proto\x12\x15optikk.ingest.logs.v1\"\xad\t\n" +
	"\x03Row\x12\x17\n" +
	...
	"\vfingerprint\x18\x0f \x01(\x04R\vfingerprint\x12\x1d\n" +
	"\n" +
	...
	"\venvironment\x18\x17 \x01(\tR\venvironment\x12\x15\n" +
	"\x06log_id\x18\x18 \x01(\tR\x05logId\x1aC\n" +
