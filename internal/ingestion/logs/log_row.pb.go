...
func (x *Row) Reset() {
	*x = Row{}
	mi := &file_internal_ingestion_logs_log_row_proto_msgTypes[0]
...
func (*Row) Descriptor() ([]byte, []int) {
	return file_internal_ingestion_logs_log_row_proto_rawDescGZIP(), []int{0}
}
...
var (
	file_internal_ingestion_logs_log_row_proto_rawDescOnce sync.Once
	file_internal_ingestion_logs_log_row_proto_rawDescData []byte
)

func file_internal_ingestion_logs_log_row_proto_rawDescGZIP() []byte {
	file_internal_ingestion_logs_log_row_proto_rawDescOnce.Do(func() {
		file_internal_ingestion_logs_log_row_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_internal_ingestion_logs_log_row_proto_rawDesc), len(file_internal_ingestion_logs_log_row_proto_rawDesc)))
	})
...
func file_internal_ingestion_logs_log_row_proto_init() {
	if File_internal_ingestion_logs_log_row_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_internal_ingestion_logs_log_row_proto_goTypes,
		DependencyIndexes: file_internal_ingestion_logs_log_row_proto_depIdxs,
		MessageInfos:      file_internal_ingestion_logs_log_row_proto_msgTypes,
	}.Build()
	File_internal_ingestion_logs_log_row_proto = out.File
	file_internal_ingestion_logs_log_row_proto_goTypes = nil
	file_internal_ingestion_logs_log_row_proto_depIdxs = nil
}
