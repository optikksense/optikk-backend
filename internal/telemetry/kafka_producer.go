...
func (k *KafkaIngester) IngestSpans(ctx context.Context, spans []SpanRecord) error {
	const chunkSize = 500
...
func (k *KafkaIngester) IngestMetrics(ctx context.Context, metrics []MetricRecord) error {
	const chunkSize = 500
...
func (k *KafkaIngester) IngestLogs(ctx context.Context, logs []LogRecord) error {
	const chunkSize = 500
