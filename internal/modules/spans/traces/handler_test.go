...
func (s *stubTraceRepository) SearchTraces(ctx context.Context, filters TraceFilters, limit int, cursorRaw string, offset int) (TraceSearchResult, error) {
	return s.result, s.searchErr
}
