...
func (h *KafkaHandler) GetKafkaSummaryStats(c *gin.Context) {
	h.handleRangeQuery(c, "Failed to query kafka summary stats", func(ctx context.Context, teamID, startMs, endMs int64) (any, error) {
		return h.Service.GetKafkaSummaryStats(ctx, teamID, startMs, endMs)
	})
}

func (h *KafkaHandler) GetProduceRateByTopic(c *gin.Context) {
	h.handleRangeQuery(c, "Failed to query produce rate by topic", func(ctx context.Context, teamID, startMs, endMs int64) (any, error) {
...
func (h *KafkaHandler) GetPublishLatencyByTopic(c *gin.Context) {
	h.handleRangeQuery(c, "Failed to query publish latency by topic", func(ctx context.Context, teamID, startMs, endMs int64) (any, error) {
...
func (h *KafkaHandler) GetConsumeRateByTopic(c *gin.Context) {
	h.handleRangeQuery(c, "Failed to query consume rate by topic", func(ctx context.Context, teamID, startMs, endMs int64) (any, error) {
...
func (h *KafkaHandler) GetReceiveLatencyByTopic(c *gin.Context) {
	h.handleRangeQuery(c, "Failed to query receive latency by topic", func(ctx context.Context, teamID, startMs, endMs int64) (any, error) {
...
func (h *KafkaHandler) GetConsumeRateByGroup(c *gin.Context) {
	h.handleRangeQuery(c, "Failed to query consume rate by group", func(ctx context.Context, teamID, startMs, endMs int64) (any, error) {
		return h.Service.GetConsumeRateByGroup(ctx, teamID, startMs, endMs)
	})
}

func (h *KafkaHandler) GetProcessRateByGroup(c *gin.Context) {
	h.handleRangeQuery(c, "Failed to query process rate by group", func(ctx context.Context, teamID, startMs, endMs int64) (any, error) {
...
func (h *KafkaHandler) GetProcessLatencyByGroup(c *gin.Context) {
	h.handleRangeQuery(c, "Failed to query process latency by group", func(ctx context.Context, teamID, startMs, endMs int64) (any, error) {
...
func (h *KafkaHandler) GetConsumerLagByGroup(c *gin.Context) {
	h.handleRangeQuery(c, "Failed to query consumer lag by group", func(ctx context.Context, teamID, startMs, endMs int64) (any, error) {
...
func (h *KafkaHandler) GetConsumerLagPerPartition(c *gin.Context) {
	h.handleRangeQuery(c, "Failed to query consumer lag per partition", func(ctx context.Context, teamID, startMs, endMs int64) (any, error) {
...
func (h *KafkaHandler) GetRebalanceSignals(c *gin.Context) {
	h.handleRangeQuery(c, "Failed to query rebalance signals", func(ctx context.Context, teamID, startMs, endMs int64) (any, error) {
		return h.Service.GetRebalanceSignals(ctx, teamID, startMs, endMs)
	})
}

func (h *KafkaHandler) GetE2ELatency(c *gin.Context) {
	h.handleRangeQuery(c, "Failed to query end-to-end latency", func(ctx context.Context, teamID, startMs, endMs int64) (any, error) {
		return h.Service.GetE2ELatency(ctx, teamID, startMs, endMs)
	})
}

func (h *KafkaHandler) GetPublishErrors(c *gin.Context) {
	h.handleRangeQuery(c, "Failed to query publish errors", func(ctx context.Context, teamID, startMs, endMs int64) (any, error) {
		return h.Service.GetPublishErrors(ctx, teamID, startMs, endMs)
	})
}

func (h *KafkaHandler) GetConsumeErrors(c *gin.Context) {
	h.handleRangeQuery(c, "Failed to query consume errors", func(ctx context.Context, teamID, startMs, endMs int64) (any, error) {
		return h.Service.GetConsumeErrors(ctx, teamID, startMs, endMs)
	})
}

func (h *KafkaHandler) GetProcessErrors(c *gin.Context) {
	h.handleRangeQuery(c, "Failed to query process errors", func(ctx context.Context, teamID, startMs, endMs int64) (any, error) {
		return h.Service.GetProcessErrors(ctx, teamID, startMs, endMs)
	})
}

func (h *KafkaHandler) GetClientOpErrors(c *gin.Context) {
	h.handleRangeQuery(c, "Failed to query client operation errors", func(ctx context.Context, teamID, startMs, endMs int64) (any, error) {
		return h.Service.GetClientOpErrors(ctx, teamID, startMs, endMs)
	})
}

func (h *KafkaHandler) GetBrokerConnections(c *gin.Context) {
	h.handleRangeQuery(c, "Failed to query broker connections", func(ctx context.Context, teamID, startMs, endMs int64) (any, error) {
...
func (h *KafkaHandler) GetClientOperationDuration(c *gin.Context) {
	h.handleRangeQuery(c, "Failed to query client operation duration", func(ctx context.Context, teamID, startMs, endMs int64) (any, error) {
