...
<<<<<<< HEAD:internal/modules/traces/service_servicemap.go
// GetServiceMap builds the per-trace service map (Datadog-style node+edge graph).
func (s *TracesService) GetServiceMap(ctx context.Context, teamID int64, traceID string) (ServiceMapResponse, error) {
=======
type Service struct {
	repo *Repository
}
...
>>>>>>> f512576e76eb5e661aabd2a3202a40891770b326:internal/modules/traces/servicemap/service.go
...
<<<<<<< HEAD:internal/modules/traces/service_servicemap.go
func (s *TracesService) GetTraceErrors(ctx context.Context, teamID int64, traceID string) ([]TraceErrorGroup, error) {
=======
