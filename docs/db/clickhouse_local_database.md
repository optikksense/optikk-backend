# Local ClickHouse Schema Documentation

This document outlines the local ClickHouse database and table schemas used for development. This version uses the `MergeTree` engine and removes sharding/replication for simplicity.
